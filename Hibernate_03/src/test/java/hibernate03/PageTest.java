...
//    t23.setStrVal("d");
  ...
  public void pageableTest() {
    try {
       ...
       * Co sprowadza siê do "limit x" dla (0,x) i "limit 2 offset 8" dla (4, 2)
       * "Strony" numerowane s¹ od 0 
       */
      //Pageable pageable = PageRequest.of(4, 2);
      Page<Integer> res = t1d.getPaged(pageable);
//      Zawartoœæ wyniku to List<X>
  ...
  //Klasa Slice rozszerza klasê Page, wiêc getSliced jako argument  
  //@Test
  ...
  //!!! Pobierany jest ca³y wynik (bez ograniczeñ) i dodatkowo wykonywany SELECT zliczaj¹cy 
  //iloœæ wyników. Pagowanie wykonywane jest ju¿ na poziomie aplikacji, czyli niewiele daje.
  //@Test
