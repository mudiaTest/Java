...
import hibernate01.oneToOne.Address5_12;
import hibernate01.oneToOne.Address5_12Dao;
import hibernate01.oneToOne.Address5_13;
import hibernate01.oneToOne.Address5_13Dao;
import hibernate01.oneToOne.Address5_14;
...
import hibernate01.oneToOne.Person5_12;
import hibernate01.oneToOne.Person5_12Dao;
import hibernate01.oneToOne.Person5_13;
import hibernate01.oneToOne.Person5_13Dao;
import hibernate01.oneToOne.Person5_14;
...
// --------------------------------------------------------------------------  
  ...
  public void person5_12() {
    Pair<Integer, Integer> ids = person5_12_Init();
      /* Dziwnie somplikowane zapytanie dla EAGER. �aczy 2 razy do tabeli z kt�rej 
       * wyszed�, bo ten rodzaj bidirectional to w�a�ciwie podw�jny unidirectional
       * select
