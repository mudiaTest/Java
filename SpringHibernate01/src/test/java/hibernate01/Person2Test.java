...
import hibernate01.oneManyEmbdedded.Person2;
import hibernate01.oneManyEmbdedded.Person2Dao;
import hibernate01.oneManyEmbdedded.PersonFeature1;
import hibernate01.oneManyEmbdedded.PersonFeature2;
import hibernate01.oneManyEmbdedded.PersonFeature2Dao;
...
public class Person2Test {
  ...
  private Integer person2Init(){
    ...
    /*
     * Konieczno�� zapisu pf1 i pf2, bo s� to Entity u�yte jako @ElementCollection. 
     * Z tego powodu nie zostaj zapisane kaskadowo. @ElementCollection nie ma opcji cascase
     * pf3 i pf4 s� w colekcji oznaczonej @OneToMany, kt�ra ma cascade i to cascade zosta�o 
     * w��czone. BEZ CASCADE te� nale�a�o by je wpierw zapisa� !
     */
