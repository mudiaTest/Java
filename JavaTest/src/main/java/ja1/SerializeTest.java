...
public class SerializeTest {
    ...
    public static void SerMultiTheSame() throws ClassNotFoundException, IOException{
        //Serializacja obiektów z referencjami powoduje zapamiętanie tych refernecji i przy odczytaniu TEGO SAMEGO podobiektu
        //Podobnie zapis kilkukrotnie tego samego obiektu nie spowoduje odczytu 2 obiektów, ale tego samego obietu.
