...
public class AnnotationsTest {
	 ...
	 //@SuppressWarnings(value="unchecked") == @SuppressWarnings("unchecked") - "value=" moĹĽna pomijaÄ‡
	 ...
	 public static void AnnotCompileTest() {
		 ...
		 //@SuppressWarnings - peĹ‚na lista wartoĹ›ci - https://stackoverflow.com/questions/2037326/all-suppresswarnings-values
