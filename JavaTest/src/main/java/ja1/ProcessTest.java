...
public class ProcessTest {          
	...
	public static void ProcessStart() throws IOException, InterruptedException {
        ...
        //Każda a metod ProcessBuilder oddaje swoją instancję, więc możliwe jest ustawanie w łańcuchu
        ...
        //Uwaga! Bufor może się przepełnić, więc należy co jakiś czas go oodczytać/oczyścić
